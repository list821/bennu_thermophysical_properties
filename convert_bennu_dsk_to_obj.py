"""Convert a type-2 NAIF DSK plate model to a plain triangular OBJ."""
...
def main():
    ...
    try:
        ...
        spice.dascls(handle)
    # DSK vertices are kilometres; use metres to match bennu_atpm.py.
    with args.output.open("w", encoding="ascii", newline="\n") as stream:
        ...
        for a, b, c in plates:  # DSK and OBJ are both one-based here.
